...
## Segundo intento
Se utilizó la placa 2020 de nuevo, se leyó la [Adicup3029 Hardware User Guide](https://wiki.analog.com/resources/eval/user-guides/eval-adicup3029/hardware/adicup3029), y se siguieron los pasos recomendados en la sección `Push Buttons` → `Function` → `3039_BOOT`.
